...
<?php $__env->startSection('title', 'Laporan - Sekolah Sepak Bola'); ?>
    ...
    <div class="col-md-3 mb-3">
        <div class="card shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('laporan.mingguan')); ?>" class="btn btn-primary btn-sm">
    ...
    <div class="col-md-3 mb-3">
        <div class="card shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('laporan.bulanan')); ?>" class="btn btn-danger btn-sm">
    ...
    <div class="col-md-3 mb-3">
        <div class="card shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('laporan.triwulan')); ?>" class="btn btn-success btn-sm">
                    <i class="bi bi-file-earmark-text"></i> Lihat Laporan
                </a>
            </div>
        </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('laporan.tahunan')); ?>" class="btn btn-info btn-sm">
                    <i class="bi bi-file-earmark-text"></i> Lihat Laporan
                </a>
            </div>
        </div>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <select class="form-select" id="selectSiswa">
                        ...
                        <?php $__currentLoopData = \App\Models\Siswa::orderBy('nama')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($siswa->id); ?>"><?php echo e($siswa->nama); ?> - <?php echo e($siswa->minat_posisi_string); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project ai\bina bola\binabola\resources\views/laporan/index.blade.php ENDPATH**/ ?>