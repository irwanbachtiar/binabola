...
<?php $__env->startSection('title', 'Evaluasi Batch - Sekolah Sepak Bola'); ?>

<?php $__env->startSection('page-title', 'Evaluasi Batch Siswa'); ?>
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <div class="mt-2">
            <small>
                ...
                <a href="<?php echo e(route('evaluasi.index')); ?>" class="alert-link">halaman Penilaian Regular</a>
            </small>
        </div>
        ...
        <form id="formSelectDate">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?php echo e(date('Y-m-d')); ?>" max="<?php echo e(date('Y-m-d')); ?>" required>
                    <input type="hidden" id="minggu" name="minggu" value="<?php echo e(date('W')); ?>">
                </div>
                <div class="col-md-4">
...
<div id="siswaContainer" style="display: none;">
    <form id="formBatchEvaluasi" method="POST" action="<?php echo e(route('evaluasi.batch.store')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project ai\bina bola\binabola\resources\views/evaluasi/batch.blade.php ENDPATH**/ ?>