...
<?php $__env->startSection('title', 'Progress Siswa'); ?>

<?php $__env->startSection('page-title', 'Progress Perkembangan Siswa'); ?>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100 border-success">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0 small"><?php echo e($bestCategory['nama'] ?? '-'); ?></h3>
                    <small class="text-muted">
                        Kategori Terbaik 
                        <?php if($bestCategory): ?>
                            (<?php echo e($bestCategory['rata_rata']); ?>)
                        <?php endif; ?>
                    </small>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100 border-danger">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0 small"><?php echo e($worstCategory['nama'] ?? '-'); ?></h3>
                    <small class="text-muted">
                        Perlu Ditingkatkan
                        <?php if($worstCategory): ?>
                            (<?php echo e($worstCategory['rata_rata']); ?>)
                        <?php endif; ?>
                    </small>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <td class="text-center">
                                    <strong class="text-info"><?php echo e(number_format($evaluasiMinggu->avg('nilai'), 1)); ?></strong>
                                </td>
                                <td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project ai\bina bola\binabola\resources\views/orangtua/siswa-progress.blade.php ENDPATH**/ ?>