...
<?php $__env->startSection('title', 'Laporan Detail Siswa'); ?>

<?php $__env->startSection('page-title', 'Laporan Detail Siswa'); ?>
    ...
    <div class="card mb-4 border-0 shadow-sm">
        <div class="card-body">
            <div class="row align-items-center">
                ...
                <div class="col">
                    <h2 class="mb-2"><?php echo e($siswa->nama); ?></h2>
                    <div class="row g-3">
                        <div class="col-auto">
                            <small class="text-muted d-block">Umur</small>
                            <strong><?php echo e($umur); ?> Tahun</strong>
                        </div>
                        <div class="col-auto">
                            <small class="text-muted d-block">Tanggal Lahir</small>
                            <strong><?php echo e(\Carbon\Carbon::parse($siswa->tanggal_lahir)->format('d M Y')); ?></strong>
                        </div>
                        <div class="col-auto">
                            <small class="text-muted d-block">Posisi</small>
                            <strong><?php echo e($siswa->minat_posisi_string); ?></strong>
                        </div>
                        <div class="col-auto">
                ...
                <div class="col-auto">
                    <a href="<?php echo e(route('laporan.siswa.detail', $siswa->id)); ?>?pdf=1" class="btn btn-danger" target="_blank">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0"><?php echo e($statistikKehadiran['hadir']); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0"><?php echo e($statistikKehadiran['izin']); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0"><?php echo e($statistikKehadiran['sakit']); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0"><?php echo e($statistikKehadiran['alpa']); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0"><?php echo e($statistikEvaluasi['total_evaluasi']); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0"><?php echo e($statistikEvaluasi['rata_rata_keseluruhan']); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100 border-success">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0"><?php echo e($statistikEvaluasi['kategori_terbaik']['nama'] ?? '-'); ?></h3>
                    <small class="text-muted">
                        Kategori Terbaik 
                        <?php if(isset($statistikEvaluasi['kategori_terbaik'])): ?>
                            (<?php echo e($statistikEvaluasi['kategori_terbaik']['rata_rata']); ?>)
                        <?php endif; ?>
                    </small>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100 border-danger">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-2 mb-0"><?php echo e($statistikEvaluasi['kategori_terlemah']['nama'] ?? '-'); ?></h3>
                    <small class="text-muted">
                        Perlu Ditingkatkan
                        <?php if(isset($statistikEvaluasi['kategori_terlemah'])): ?>
                            (<?php echo e($statistikEvaluasi['kategori_terlemah']['rata_rata']); ?>)
                        <?php endif; ?>
                    </small>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    ?>
                                    <strong class="text-info"><?php echo e(number_format($rataRata, 1)); ?></strong>
                                </td>
                                <td>
                                    <small><?php echo e($evaluasiMinggu->first()->catatan ?: '-'); ?></small>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
...
<script>
    ...
    new Chart(ctxLine, {
        type: 'line',
        data: {
            labels: <?php echo json_encode($lineChartData['labels']); ?>,
            datasets: [{
                label: 'Jumlah Kehadiran',
                data: <?php echo json_encode($lineChartData['data']); ?>,
                borderColor: '#667eea',
    ...
    new Chart(ctxProgress, {
        type: 'line',
        data: {
            labels: <?php echo json_encode($progressChartData['labels']); ?>,
            datasets: [{
                label: 'Rata-rata Nilai',
                data: <?php echo json_encode($progressChartData['data']); ?>,
                borderColor: '#28a745',
    ...
    new Chart(ctxRadar, {
        type: 'radar',
        data: {
            labels: <?php echo json_encode($radarChartData['labels']); ?>,
            datasets: [{
                label: 'Nilai',
                data: <?php echo json_encode($radarChartData['data']); ?>,
                borderColor: '#667eea',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project ai\bina bola\binabola\resources\views/laporan/siswa-detail.blade.php ENDPATH**/ ?>