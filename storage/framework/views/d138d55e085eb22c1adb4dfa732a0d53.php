...
<?php $__env->startSection('title', 'Bina Bola - Sekolah Sepak Bola'); ?>
...
<div class="container py-5">
    <div class="row align-items-center">
        <div class="col-md-6">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg me-2">Daftar Sekarang</a>
            <a href="<?php echo e(route('laporan.index')); ?>" class="btn btn-outline-secondary btn-lg">Pelajari Lebih Lanjut</a>
            <div class="mt-4">
                <small class="text-muted"><i class="bi bi-geo-alt"></i> Lokasi: Jakarta • Jadwal latihan: Sabtu & Minggu</small>
            </div>
        </div>
        <div class="col-md-6 text-center">
            <img src="<?php echo e(asset('images/landing-soccer.png')); ?>" alt="Bina Bola" class="img-fluid" style="max-height:320px;">
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary w-100">Daftar Sekarang</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project ai\bina bola\binabola\resources\views/landing.blade.php ENDPATH**/ ?>