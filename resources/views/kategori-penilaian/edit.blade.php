...
@section('page-title', 'Edit Kategori Penilaian')
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('kategori-penilaian.update', $kategoriPenilaian->id) }}" method="POST" id="formKategori">
                    @csrf
                    @method('PUT')
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tipe" id="tipeParent" value="parent" 
                                       {{ old('tipe', $kategoriPenilaian->parent_id ? 'sub' : 'parent') == 'parent' ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tipe" id="tipeSub" value="sub"
                                       {{ old('tipe', $kategoriPenilaian->parent_id ? 'sub' : 'parent') == 'sub' ? 'checked' : '' }}>
                    ...
                    <div class="mb-3" id="parentSelectWrapper" style="{{ $kategoriPenilaian->parent_id ? '' : 'display: none;' }}">
                        ...
                        <select class="form-select @error('parent_id') is-invalid @enderror" 
                            ...
                            @foreach($parents as $parent)
                                <option value="{{ $parent->id }}" {{ old('parent_id', $kategoriPenilaian->parent_id) == $parent->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('kelompok_umur') is-invalid @enderror" 
                            ...
                            <option value="U-7" {{ old('kelompok_umur', $kategoriPenilaian->kelompok_umur) == 'U-7' ? 'selected' : '' }}>U-7</option>
                            <option value="U-12" {{ old('kelompok_umur', $kategoriPenilaian->kelompok_umur) == 'U-12' ? 'selected' : '' }}>U-12</option>
                        </select>
                        @error('kelompok_umur')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="nama" 
                               name="nama" 
                               value="{{ old('nama', $kategoriPenilaian->nama) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                  ...
                                  name="deskripsi" 
                                  rows="3" 
                                  placeholder="Deskripsi singkat tentang kategori ini">{{ old('deskripsi', $kategoriPenilaian->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" 
                               ...
                               id="urutan" 
                               name="urutan" 
                               value="{{ old('urutan', $kategoriPenilaian->urutan) }}" 
                               min="1"
                               required>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" 
                                   ...
                                   id="aktif" 
                                   name="aktif" 
                                   {{ old('aktif', $kategoriPenilaian->aktif) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" 
                                   ...
                                   {{ old('minggu_terakhir', $kategoriPenilaian->minggu_terakhir) ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('pageshow', function() {
        if (submitBtn.disabled) {
            ...
            submitBtn.innerHTML = '<i class="bi bi-save"></i> Update Kategori';
        }
    });
});
</script>
